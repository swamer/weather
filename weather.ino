...
const char* password = "renshanbin";
//==========目标服务器网址和端口==============//
const char* host = "116.62.81.138";  //api.seniverse.com
const uint16_t port = 80 ;
//===============地区设置===================//
String City = "郑州";//城市
String My_Key = "SU5xN5FWsZgUEOuVK";//禁止泄露
//===============OLED引脚===================//
...
static const unsigned char PROGMEM f1_bmp[] =
{  };
...
,
...
static const unsigned char PROGMEM diqu[][32] =
{
  {0x22,0x00,0x12,0x3E,0x14,0x22,0x7F,0x24,0x08,0x24,0x08,0x28,0x08,0x24,0xFF,0xA4,0x08,0x22,0x08,0x22,0x14,0x22,0x12,0x34,0x21,0x28,0x41,0x20,0x80,0x20,0x00,0x20},//"郑",
  {0x10,0x04,0x10,0x84,0x10,0x84,0x10,0x84,0x10,0x84,0x54,0xA4,0x52,0x94,0x52,0x94,0x90,0x84,0x10,0x84,0x10,0x84,0x10,0x84,0x20,0x84,0x20,0x84,0x40,0x04,0x80,0x04},//"州",
};
//====================================================数组END=======================================================================//
void setup() {
    Serial.begin(9600);
...
void loop()
{
    ...
    display.setTextSize(3);                                   //Near it display the average BPM you can display the BPM if you want
  ...
  if (checkForBeat(irValue) == true)                        //If a heart beat is detected
  {
    ...
    display.setTextSize(3);                                //And still displays the average BPM
    display.setTextColor(WHITE);             
    display.setCursor(50,0);                
    display.println("BPM");             
    display.setCursor(53,25);                
    ...
    if (irValue < 7000){       //If no finger is detected it inform the user and put the average BPM to 0 or it will be stored for the next measure
     ...
     display.drawBitmap(39, 20, f1_bmp, 60, 60, WHITE);
     display.display();
     noTone(3);
     }
  }
...
void DisplayTime()
{
    if(OnTime ==0 or OnTime == 1)
    {
        ...
        //display.print("Zhengzhou");//显示地区  
        display.drawBitmap(32,0,diqu[0],16,16,1);//郑
        display.drawBitmap(80,0,diqu[1],16,16,1);//州 
        display.setCursor(33,20);//设置光标
        display.printf("%d:%d",dTime.Hour,dTime.Minute);//时间
        display.setCursor(15,40);//设置光标
...
void processMessage()
{
  const size_t capacity = JSON_ARRAY_SIZE(1) + JSON_ARRAY_SIZE(3) + JSON_OBJECT_SIZE(1) + JSON_OBJECT_SIZE(3) + JSON_OBJECT_SIZE(6) + 3*JSON_OBJECT_SIZE(14) + 810;
    ...
    const char* results_0_daily_0_date = results_0_daily_0["date"]; // "2020-03-08"
    ...
    const char* results_0_daily_0_high = results_0_daily_0["high"]; // "16"
    const char* results_0_daily_0_low = results_0_daily_0["low"]; // "9"
    ...
    const char* results_0_daily_0_wind_direction = results_0_daily_0["wind_direction"]; // "东南"
    const char* results_0_daily_0_wind_direction_degree = results_0_daily_0["wind_direction_degree"]; // "135"
    ...
    const char* results_0_daily_0_humidity = results_0_daily_0["humidity"]; // "78"
    
    JsonObject results_0_daily_1 = results_0_daily[1];
    const char* results_0_daily_1_date = results_0_daily_1["date"]; // "2020-03-09"
    ...
    const char* results_0_daily_1_high = results_0_daily_1["high"]; // "13"
    const char* results_0_daily_1_low = results_0_daily_1["low"]; // "5"
    const char* results_0_daily_1_rainfall = results_0_daily_1["rainfall"]; // "3.3"
    ...
    const char* results_0_daily_1_humidity = results_0_daily_1["humidity"]; // "73"
    
    JsonObject results_0_daily_2 = results_0_daily[2];
    const char* results_0_daily_2_date = results_0_daily_2["date"]; // "2020-03-10"
    ...
    const char* results_0_daily_2_low = results_0_daily_2["low"]; // "4"
    const char* results_0_daily_2_rainfall = results_0_daily_2["rainfall"]; // "0.0"
    const char* results_0_daily_2_precip = results_0_daily_2["precip"]; // ""
    const char* results_0_daily_2_wind_direction = results_0_daily_2["wind_direction"]; // "西北"
    ...
    const char* results_0_daily_2_humidity = results_0_daily_2["humidity"]; // "38"
    
    const char* results_0_last_update = results_0["last_update"]; // "2020-03-08T17:23:47+08:00"
